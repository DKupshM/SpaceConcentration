...
public class PlanetGenerator : MonoBehaviour
{
	...
	private void Offset ()
	{
		...
		switch (offset) {
		case 1:
			offsetVec = new Vector3 (Random.Range (0.01f, 0.05f), 0, 0);
			break;
		case 2:
			offsetVec = new Vector3 (0, Random.Range (0.01f, 0.05f), 0);
			break;
		case 3: 
			offsetVec = new Vector3 (0, 0, Random.Range (0.01f, 0.05f));
			break;
		}
